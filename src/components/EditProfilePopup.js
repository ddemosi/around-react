...
function EditProfilePopup(props) {
    ...
    return(
        ...
        <div className="form__text-field-wrapper form-width">
                <input ref={nameRef} onChange={onNameChange} id="profile-name" className="form__text-field form__input form__input_name" placeholder="Name" type="text" defaultValue={currentUser.name} minLength="2" maxLength="40" required />
                <span id="profile-name-error" className="form__error"></span>
            </div>
            <div className="form__text-field-wrapper form-width">
                <input ref={aboutRef} onChange={onDescriptionChange} id="profile-about" className="form__text-field form__input form__input_about" placeholder="About me" type="text" defaultValue={currentUser.about} minLength="2" maxLength="200" required />
